...
tags:
  ...
  - DOTS
  - Update Manager
title: Update objects using DOTS without ECS
description: How to use Unity's C# Job System to run Update methods every frame the easy way
date: 2023-11-21
highlight_languages:
  - csharp
---
...
## Using Burst
To use the Burst compiler and have update jobs compiled to highly optimized native code, all we need to do is change the job struct definition to implement `IBurstUpdateTransformJob<>` instead of `IUpdateTransformJob`:
