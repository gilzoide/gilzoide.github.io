...
tags:
  ...
  - SQL
  - SQLite
title: "ECSQL: Starting the prototype: a world with entities, components and systems"
description: 
date: 2024-12-15
highlight_languages:
  - cpp
originally_published_at: https://github.com/gilzoide/ecsql/blob/main/articles/02-prototyping-en.md
collection: ecsql
---

In the [previous article](../2024-11-01-ecs-databases) I showed you how we can model ECS worlds as relational databases.
